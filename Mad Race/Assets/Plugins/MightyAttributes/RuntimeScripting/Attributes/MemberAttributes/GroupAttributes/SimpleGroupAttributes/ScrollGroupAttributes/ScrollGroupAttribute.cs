...
{
    public class SimpleScrollGroupAttribute : BaseSimpleScrollGroupAttribute
    {
        public override ColorValue GetDefaultBackgroundColor() => ColorValue.White;

        /// <summary>
        /// Group together several members inside a simple scrollable area of a specified height.
        ...
        public SimpleScrollGroupAttribute(string groupName, float height = 100, bool drawName = true, bool nameAsCallback = false,
        ...
        /// <param name="lineColor">The color value of the line (default: Contrast).
        /// See the doc fore more info on color values.</param>
        public SimpleScrollGroupAttribute(string groupName, float height, bool drawName, bool nameAsCallback, ColorValue backgroundColor,
        ...
        /// <param name="contentColor">The content color value of the group (default: Default).
        /// See the doc fore more info on color values.</param>
        public SimpleScrollGroupAttribute(string groupName, float height, ColorValue backgroundColor,
        ...
        /// <param name="contentColor">The content color value of the group (default: Default).
        /// See the doc fore more info on color values.</param>
        public SimpleScrollGroupAttribute(float height = 100, ColorValue backgroundColor = ColorValue.White,
            ColorValue contentColor = ColorValue.Default) : base(height, backgroundColor, contentColor)
        {
        }
    }

    public class SimpleScrollAttribute : SimpleScrollGroupAttribute, IInheritDrawer
    {
        /// <summary>
        /// Group together several members inside a simple scrollable area of a specified height.
        /// All Scroll Groups with the same group name will use the height specify in the first attribute of that group name.
        ...
        /// <param name="lineColor">The color value of the line (default: Contrast).
        /// See the doc fore more info on color values.</param>
        public SimpleScrollAttribute(string groupName, float height = 100, bool drawName = true, bool nameAsCallback = false,
            string backgroundColorName = null, string contentColorName = null, bool drawLine = true,
            ColorValue lineColor = ColorValue.Contrast)
            : base(groupName, height, drawName, nameAsCallback, backgroundColorName, contentColorName, drawLine, lineColor)
        {
        ...
        /// <param name="lineColor">The color value of the line (default: Contrast).
        /// See the doc fore more info on color values.</param>
        public SimpleScrollAttribute(string groupName, float height, bool drawName, bool nameAsCallback, ColorValue backgroundColor,
            ColorValue contentColor = ColorValue.Default, bool drawLine = true, ColorValue lineColor = ColorValue.Contrast)
            : base(groupName, height, drawName, nameAsCallback, backgroundColor, contentColor, drawLine, lineColor)
        {
        }
        ...
        /// <param name="contentColor">The content color value of the group (default: Default).
        /// See the doc fore more info on color values.</param>
        public SimpleScrollAttribute(string groupName, float height, ColorValue backgroundColor, ColorValue contentColor = ColorValue.Default) :
        ...
        /// <param name="contentColor">The content color value of the group (default: Default).
        /// See the doc fore more info on color values.</param>
        public SimpleScrollAttribute(float height = 100, ColorValue backgroundColor = ColorValue.White,
            ColorValue contentColor = ColorValue.Default) :
            base(height, backgroundColor, contentColor)
        {
        }
    }
}