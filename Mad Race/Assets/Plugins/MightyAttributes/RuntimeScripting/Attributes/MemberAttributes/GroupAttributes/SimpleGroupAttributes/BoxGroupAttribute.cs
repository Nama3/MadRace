...
{
    public class BoxGroupAttribute : BaseSimpleGroupAttribute
    {
        public override ColorValue GetDefaultBackgroundColor() => ColorValue.White;

        /// <summary>
        /// Group together several members inside a simple box area.
        /// </summary>
        ...
        public BoxGroupAttribute(string groupName, bool drawName = true, bool nameAsCallback = false, string backgroundColorName = null, 
            string contentColorName = null, bool drawLine = true, ColorValue lineColor = ColorValue.Contrast)
        ...
        /// See the doc fore more info on color values.</param>
        /// <param name="drawLine">Choose whether or not to draw line between the group name and the content of the group (default: true).</param>
        /// <param name="lineColor">The color value of the line (default: ColorValue.Contrast).
        /// See the doc fore more info on color values.</param>
        public BoxGroupAttribute(string groupName, bool drawName, bool nameAsCallback, ColorValue backgroundColor,
        ...
        /// See the doc fore more info on color values.</param>
        public BoxGroupAttribute(string groupName, ColorValue backgroundColor, ColorValue contentColor = ColorValue.Default) 
            : base(groupName, backgroundColor, contentColor, ColorValue.Contrast)
        {
        }
        ...
        /// <param name="contentColor">The content color value of the group (default: ColorValue.Default).
        /// See the doc fore more info on color values.</param>
        public BoxGroupAttribute(ColorValue backgroundColor = ColorValue.White, ColorValue contentColor = ColorValue.Default) 
            : base(backgroundColor, contentColor)
        {
        }
    }

    public class BoxAttribute : BoxGroupAttribute, IInheritDrawer
    {
        /// <summary>
        /// Group together several members inside a simple box area.
        /// </summary>
        ...
        /// <param name="lineColor">The color value of the line (default: ColorValue.Contrast).
        /// See the doc fore more info on color values.</param>
        public BoxAttribute(string groupName, bool drawName = true, bool nameAsCallback = false, string backgroundColorName = null, 
            string contentColorName = null, bool drawLine = true, ColorValue lineColor = ColorValue.Contrast)
            : base(groupName, drawName, nameAsCallback, backgroundColorName, contentColorName, drawLine, lineColor)
        {
        }
        ...
        /// <param name="lineColor">The color value of the line (default: ColorValue.Contrast).
        /// See the doc fore more info on color values.</param>
        public BoxAttribute(string groupName, bool drawName, bool nameAsCallback, ColorValue backgroundColor,
            ColorValue contentColor = ColorValue.Default, bool drawLine = true, ColorValue lineColor = ColorValue.Contrast)
            : base(groupName, drawName, nameAsCallback, backgroundColor, contentColor, drawLine, lineColor)
        {
        }
        ...
        /// <param name="contentColor">The content color value of the group (default: ColorValue.Default).
        /// See the doc fore more info on color values.</param>
        public BoxAttribute(string groupName, ColorValue backgroundColor, ColorValue contentColor = ColorValue.Default)
        ...
        /// <param name="contentColor">The content color value of the group (default: ColorValue.Default).
        /// See the doc fore more info on color values.</param>
        public BoxAttribute(ColorValue backgroundColor = ColorValue.White, ColorValue contentColor = ColorValue.Default) 
            : base(backgroundColor, contentColor)
        {
        }
    }
