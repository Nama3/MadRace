...
{
    public class BoldLabelAttribute : BaseLabelAttribute
    {
        /// <summary>
        /// Draws a bold label around the member.
        /// </summary>
        /// <param name="label">The text of the label.</param>
        /// <param name="position">The position options of the decoration.</param>
        public BoldLabelAttribute(string label, DecoratorPosition position) : base(label, false, position)
        {
        }

        /// <summary>
        /// Draws a bold label with a prefix around the member.
        /// </summary>
        /// <param name="prefix"> The text of the prefix.</param>
        /// <param name="label">The text of the label.</param>
        /// <param name="position">The position options of the decoration.</param>
        public BoldLabelAttribute(string prefix, string label, DecoratorPosition position) : base(prefix, label, false, false, position)
        {
        }
        ...
        /// <param name="position">The position options of the decoration.</param>
        public BoldLabelAttribute(string label, bool labelAsCallback, DecoratorPosition position) : base(label, labelAsCallback, position)
        {
        }
        ...
        public BoldLabelAttribute(string prefix, string label, bool prefixAsCallback = false, bool labelAsCallback = false,
        ...
        public BoldLabelAttribute(string label, bool labelAsCallback = false, string positionCallback = null)
